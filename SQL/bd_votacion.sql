...
-- Volcando estructura de base de datos para db_votacion
CREATE DATABASE IF NOT EXISTS `db_votacion` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci */;
USE `db_votacion`;

-- Volcando estructura para tabla db_votacion.candidatos
...
-- Volcando datos para la tabla db_votacion.candidatos: 10 rows
DELETE FROM `candidatos`;
/*!40000 ALTER TABLE `candidatos` DISABLE KEYS */;
INSERT INTO `candidatos` (`id_candidato`, `nombre`, `apellidos`) VALUES
	(1, 'ESTEFANIA', 'AROCAS PASADAS'),
	(2, 'QUERALT', 'VISO GILABERT'),
	(3, 'JOAN', 'AYALA FERRERAS'),
	(4, 'JOAN', 'BAEZ TEJADO'),
	(5, 'MARC', 'BASTARDES SOTO'),
	(6, 'JOSEP', 'ANGUERA VILAFRANCA'),
	(7, 'ESTHER', 'PASCUAL ALOY'),
	(8, 'LAURA', 'VALLÉS GIRVENT'),
	(9, 'RAQUEL', 'RAYA GARCIA'),
	(10, 'JOAN', 'ANDREU CRUZ');
/*!40000 ALTER TABLE `candidatos` ENABLE KEYS */;

-- Volcando estructura para tabla db_votacion.comunas
...
-- Volcando datos para la tabla db_votacion.comunas: 346 rows
DELETE FROM `comunas`;
...
-- Volcando estructura para tabla db_votacion.provincias
...
-- Volcando datos para la tabla db_votacion.provincias: 53 rows
...
-- Volcando estructura para tabla db_votacion.regiones
...
-- Volcando datos para la tabla db_votacion.regiones: 15 rows
...
-- Volcando estructura para tabla db_votacion.registro_votaciones
CREATE TABLE IF NOT EXISTS `registro_votaciones` (
  ...
  `op_web` tinyint(4) DEFAULT NULL,
  `op_tv` tinyint(4) DEFAULT NULL,
  `op_rs` tinyint(4) DEFAULT NULL,
  `op_amigo` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `rut_UNIQUE` (`rut`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla db_votacion.registro_votaciones: 0 rows
DELETE FROM `registro_votaciones`;
/*!40000 ALTER TABLE `registro_votaciones` DISABLE KEYS */;
/*!40000 ALTER TABLE `registro_votaciones` ENABLE KEYS */;
